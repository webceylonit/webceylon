        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="{{ route('inquiries.index') }}">
                            <svg class="stroke-icon" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="{{ route('services.index') }}">
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="{{ route('feedbacks.index') }}">
                            <svg class="stroke-icon" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="{{ route('team.index') }}">
                            <svg class="stroke-icon" width="20" height="20" fill="none" stroke="currentColor"
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="{{ route('social.index') }}">
                            <svg class="stroke-icon" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
