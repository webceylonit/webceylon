            ...
            <div class="row g-4">
                <div class="col-lg-5">
                    <div class="contact__left-item primary-bg">
                        ...
                        <p class="text-white">Get in touch with us for any inquiries or support.
                            We're here to help you with your projects, questions, or service needs.</p>
                        <ul class="mt-40 mb-40">
                            <li>
                                ...
                                <div>
                                    ...
                                    <h3 class="mt-1"><a class="text-white" >{{$socialLinks->contact ?? 'unavailable'}}</a>
                                    </h3>
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    ...
                                    <h3 class="mt-1"><a class="text-white"href="{{ isset($socialLinks->email) ? 'mailto:' . $socialLinks->email : '#' }}">{{ $socialLinks->email ?? 'unavailable' }}</a>
                                    </h3>
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    ...
                                    <h4 class="mt-1"><a class="text-white" href="tel:+94 77 995 4063">No 156, Kaduwela Road, <br /> Athurugiriya, Sri Lanka</a>
                                    </h4>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="contact__right-item">
                        <div class="section-header mb-20">
                            ...
                            <p class="wow fadeInUp mt-3" data-wow-delay="400ms" data-wow-duration="1500ms">
                                We offer tailored solutions to help your business grow. Our team is
                                dedicated to delivering quality, reliability, and support every step of the way.
                            </p>
