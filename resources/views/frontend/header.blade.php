...
<!-- Top header area start here -->
    ...
    <header class="header-area "  style="height:80px; display: flex; align-items: center;">
        <div class="container header__container">
            <div class="header__main">
                <a href="{{ route('index') }}" class="logo">
                    <img src="{{ asset('whitelogo2.png') }}" alt="Webceylon">
                </a>
                <div class="main-menu">
                    <nav>
                        <ul>
                 ...
                 <div class="d-none d-lg-inline-block">
                    <a href="{{ route('contact') }}" class="btn-one pt-2 pb-2">Get A Quote <i
    ...
    <div id="targetElement" class="sidebar-area sidebar__hide">
        ...
        <ul class="info pt-40">
            <li><i class="fa-solid primary-color fa-location-dot"></i> <a href="#0">No 156/1/A, Kaduwela Road, Athurugiriya, Sri Lanka</a>
            </li>
