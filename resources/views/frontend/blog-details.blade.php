        ...
        <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
            ...
            <div class="container">
                ...
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index.html">Home</a><span><i class="fa-regular fa-angles-right mx-2"></i>Blog Details
                        </span>
                </div>
            </div>
        </section>
                ...
                <div class="row g-4">
                    <div class="col-lg-8 order-2 order-lg-1">
                        <div class="blog__item blog-single__left-item shadow-none">
                            <div class="image">
                                <img src="frontend/assets/images/blog/blog-single-image1.jpg" alt="image">
                            </div>
                            <div class="blog__content p-0">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="image">
                                            <img src="frontend/assets/images/blog/blog-single-sm1.jpg" alt="image">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="image">
                                            <img src="frontend/assets/images/blog/blog-single-sm2.jpg" alt="image">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="blog-single__review mt-60">
                            ...
                            <div class="blog-single__comment d-flex gap-4 mt-60 pb-60 bor-bottom">
                                <div class="image">
                                    <img src="frontend/assets/images/blog/comment-image1.png" alt="image">
                                </div>
                                <div class="content">
                        ...
                        <div class="blog-single__right-item">
                            ...
                            <div class="item sub-bg mb-30">
                                ...
                                <ul class="single-post">
                                    <li>
                                        <img src="frontend/assets/images/blog/post-sm1.png" alt="image">
                                        <div class="con">
                                    ...
                                    <li>
                                        <img src="frontend/assets/images/blog/post-sm2.png" alt="image">
                                        <div class="con">
                                            <span><svg class="me-1" width="20" height="20" viewBox="0 0 20 20"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <li>
                                        <img src="frontend/assets/images/blog/post-sm3.png" alt="image">
                                        <div class="con">
                                            <span><svg class="me-1" width="20" height="20" viewBox="0 0 20 20"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
