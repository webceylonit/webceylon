    ...
    <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
        ...
        <div class="container">
            ...
            <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <a href="{{ route('index') }}">Home</a><span><i class="fa-regular fa-angles-right mx-2"></i>Blog Details</span>
            </div>
        </div>
    </section>
                        ...
                        <div class="blog__content p-0">
                            ...
                            <ul class="pb-3 pt-30 bor-bottom d-flex gap-4 flex-wrap align-items-center">
                                <li>
                                    ...
                                    <a><span class="primary-hover transition">By {{ $blog->author }}</span></a>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <a><span class="primary-hover transition">{{ $blog->category }}</span></a>
                                </li>
                            </ul>
                ...
                <div class="col-lg-4 order-1 order-lg-2">
                    <div class="blog-single__right-item">
                        <div class="item sub-bg mb-30">
                            ...
                            <ul class="category">
                                <li><a href="#0">Web Development</a> <span></span></li>
                                <li><a href="#0">ERP System Development</a> <span></span></li>
                                <li><a href="#0">SEO (Search Engine Optimization)</a> <span></span></li>
                                <li><a href="#0">Digital Marketing</a> <span></span></li>
                            </ul>
                        </div>
                        <div class="item sub-bg mb-30">
                            ...
                            <ul class="single-post">
                                ...
                                <li>
                                    ...
                                    <div class="con">
                                        ...
                                        <h5 class="mt-2">
                                            <a href="{{ route('blog-details', $relatedBlog->id) }}" class="primary-hover">
                                                {{ \Illuminate\Support\Str::limit($relatedBlog->title, 10) }}
                                            </a>
                                        </h5>
