...
<main>
    ...
    <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
        ...
        <div class="container">
            ...
            <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <a href="{{ route('index') }}">Home</a><span><i class="fa-regular fa-angles-right mx-2"></i>Blogs</span>
            </div>
        </div>
    </section>
    ...
    <section class="py-5 bg-light">
        <div class="container text-center">
            <h2 class="fw-bold mb-3">Insights, Ideas & Innovations</h2>
            <p class="text-secondary mb-0" style="max-width: 800px; margin: 0 auto;">
                Welcome to the <strong>Webceylon</strong> blog — your destination for expert insights, industry trends, and technical knowledge in software and web development. Stay updated with articles from our team, sharing thoughts, tips, and updates to inspire digital growth and innovation.
            </p>
        </div>
    </section>

    <section class="blog-area pt-30 pb-120">
        <div class="container">
            <div class="row g-4">
