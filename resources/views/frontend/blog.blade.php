        ...
        <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
            ...
            <div class="container">
                ...
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index.html">Home</a><span><i class="fa-regular fa-angles-right mx-2"></i>Blogs
                        </span>
                </div>
            </div>
        </section>
                ...
                <div class="row g-4">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                        ...
                        <div class="blog__item">
                            <a href="{{ route('blog-details') }}" class="blog__image d-block image">
                            ...
                            <div class="blog__content">
                                ...
                                <h3><a href="{{ route('blog-details') }}" class="primary-hover">Necessity May Give us Best Virtual
                                        Court</a></h3>
                                <a class="mt-25 read-more-btn" href="{{ route('blog-details') }}">Read More <i
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms"
                        data-wow-duration="1500ms">
                        <div class="blog__item">
                            <a href="{{ route('blog-details') }}" class="blog__image image d-block">
                            ...
                            <div class="blog__content">
                                ...
                                <h3><a href="{{ route('blog-details') }}" class="primary-hover">Tackling the Changes of Retail
                                        Industry</a></h3>
                                <a class="mt-25 read-more-btn" href="{{ route('blog-details') }}">Read More <i
                                        class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms"
                        ...
                        <div class="blog__item">
                            ...
                            <div class="blog__content">
                                ...
                                <h3><a href="{{ route('blog-details') }}" class="primary-hover">Easy and Most Powerful Server and
                                        Platform</a>
                                </h3>
                                <a class="mt-25 read-more-btn" href="{{ route('blog-details') }}">Read More <i
                                        class="fa-regular fa-arrow-right-long"></i></a>
