...
<p>Boost traffic and conversions through content, social media, email campaigns, and paid ads  (Google Ads, Facebook Ads).</p>
            ...
            <div class="swiper case__slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="frontend/assets/images/case/case-image11.jpg" alt="image">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">Development</span>
                                <h3><a href="case-details.html" class="text-white primary-hover">ERP System </a></h3>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="frontend/assets/images/case/case-image22.jpg" alt="image">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">Solution</span>
                                <h3><a href="case-details.html" class="text-white primary-hover">SEO</a></h3>
                            </div>
                            <a href="case-details.html" class="case__btn">
                                <i class="fa-regular fa-arrow-right"></i>
                            </a>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="frontend/assets/images/case/case-image33.jpg" alt="image">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">Solution</span>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="frontend/assets/images/case/case-image44.jpg" alt="image">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">Solution</span>
                                <h3><a href="case-details.html" class="text-white primary-hover">Digital Marketing</a>
                                </h3>
                            </div>
                            <a href="case-details.html" class="case__btn">
                                <i class="fa-regular fa-arrow-right"></i>
        ...
        <section class="offer-area secondary-bg pt-120 pb-200">
            <div class="offer__shadow wow fadeIn" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img src="frontend/assets/images/shape/offer-shadow-shape.png" alt="shadow">
            </div>
            <div class="offer__shape-left">
                <img class="wow fadeInUpBig" data-wow-delay="400ms" data-wow-duration="1500ms"
                    src="frontend/assets/images/shape/offer-bg-shape-left.png" alt="shape">
            </div>
            <div class="offer__shape-right">
                <img class="wow fadeInDownBig" data-wow-delay="400ms" data-wow-duration="1500ms"
                    src="frontend/assets/images/shape/offer-bg-shape-right.png" alt="shape">
            </div>
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="00ms"
                        ...
                        <div class="offer__item">
                            <div class="shape-top">
                                <img src="frontend/assets/images/shape/offter-item-shape-top.png" alt="shape">
                            </div>
                            <div class="shape-bottom">
                                <img src="frontend/assets/images/shape/offter-item-shape-bottom.png" alt="shape">
                            </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                        ...
                        <div class="blog__item">
                            <a href="blog-details.html" class="blog__image d-block image">
                                <img src="frontend/assets/images/blog/blog-image11.jpg" alt="image">
                                <div class="blog-tag">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms"
                        ...
                        <div class="blog__item">
                            <a href="blog-details.html" class="blog__image image d-block">
                                <img src="frontend/assets/images/blog/blog-image22.jpg" alt="image">
                                <div class="blog-tag">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms"
                        ...
                        <div class="blog__item">
                            <a href="blog-details.html" class="blog__image image d-block">
                                <img src="frontend/assets/images/blog/blog-image33.jpg" alt="image">
                                <div class="blog-tag">
