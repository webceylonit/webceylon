                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="process__item mb-100">
                        ...
                        <div class="process__content">
                            ...
                            <p>We begin by learning about your business operations, challenges, and goals to determine the most suitable digital or software solution that delivers real value.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="process__item mb-100">
                        ...
                        <div class="process__content">
                            ...
                            <p>We prepare a clear development roadmap and system structure for your website, ERP, or custom solution, ensuring it aligns with your operational and growth needs.</p>
                        </div>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="process__item">
                        ...
                        <div class="process__content">
                            ...
                            <p>Our team builds and delivers fully functional, reliable software or web solutions with ongoing testing, integration, and support to ensure long-term success.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{ route('inquiry.store') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" id="number" name="phone" placeholder="Contact">
                                </div>
                                <div class="col-12">
                                    <label for="massage">Message*</label>
                                    <textarea id="massage" name="message" placeholder="Write Message" required></textarea>
                                </div>
                            </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial__item">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div class="testi-info">
                                            ...
                                            <p>
                                                ...
                                                @if($feedback->company) at <b>{{ $feedback->company }}</b> @endif
                                            </p>
                                            <!-- <div class="star mt-1">
                                    ...
                                    <p class="mt-30">“ {{ $feedback->feedback }}”</p>
                                </div>
                            </div>
                            @empty
                            <div class="swiper-slide">
                                <div class="testimonial__item text-center p-5">
                                    <svg class="coma mb-3" width="50" height="37" viewBox="0 0 50 37" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 0V37L18.75 18.5V0H0ZM31.25 0V37L50 18.5V0H31.25Z" fill="#3C72FC" />
                                    </svg>
                                    <h4>No Reviews Yet</h4>
                                    <p class="mt-2">Client feedback will appear here once available. Be the first to leave one!</p>
                                </div>
                            </div>
                            @endforelse
                        </div>
