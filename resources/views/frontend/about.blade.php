            ...
            <div class="row g-4">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                    ...
                    <div class="team__item">
                        <div class="image">
                            <img src="{{ asset('public/storage/' . $member->image) }}" alt="{{ $member->name }}" style="height:370px;">
                        </div>
                        ...
                        <div class="team__share">
                            <ul>
                                @if($member->fb_link)
                                <li><a href="{{ $member->fb_link }}" target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
                                @endif
                                @if($member->linkedin_link)
                                <li><a href="{{ $member->linkedin_link }}" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a></li>
                                @endif
                                @if($member->portfolio_link)
                                <li><a href="{{ $member->portfolio_link }}" target="_blank"><i class="fa-solid fa-globe"></i></a></li>
                                @endif
                            </ul>
